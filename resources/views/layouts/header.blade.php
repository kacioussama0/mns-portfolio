...
<head>
    ...
    <meta name="description" content="I'm Into 3D Architectural Filed And Video Editing For More Than 5 Year Of Experience">
    ...
    <title>Chosen Studio | @yield('title')</title>
</head>
    ...
    <div class="footer_section">
                ...
                <div class="row">
                    <div class="col-sm-4 text-center">
                        <div class="contact_info">
                            ...
                            <p>155 Saoula - Bir Mourad Raïs</p>
                            <p>Algeria</p>
                        </div>
                    </div>
                    <div class="col-sm-4 text-center">
                        <div class="contact_info">
                            ...
                            <p><a href="javascript:;">+(213) 540 99 43 48</a></p>
                            <p><a href="javascript:;">+(213) 672 09 55 60</a></p>
                        </div>
                    </div>
                    <div class="col-sm-4 text-center">
                        <div class="contact_info">
                            ...
                            <p><a href="javascript:;">ayman.service1994@gmail.com</a></p>
                            <p><a href="javascript:;">contact@chosen-studio.net</a></p>
                        </div>
                    </div>
        ...
        <div class="copy_right_wrapper ">
            <div class="col-12 text-center">
                <p class="copy_right">Copyright &copy; 2023 <a href="javascript:;">Chosen Studio.</a> All Rights
                    Reserved</p>
            </div>
        </div>
    </div>
...
<script src="{{asset('assets/js/cvtext1.js')}}"></script>
<script src="{{asset('assets/js/cvtext2.js')}}"></script>
